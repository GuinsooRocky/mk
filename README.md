...
[**📦 MK-v0.3.4.zip → 点击下载**](https://github.com/GuinsooRocky/mike/releases/download/v0.3.4/MK-v0.3.4.zip)

> 全部 release 列表：[github.com/GuinsooRocky/mike/releases](https://github.com/GuinsooRocky/mike/releases)
>
> v0.3.4 vs v0.2.0：zip 4.1MB → **371KB**（-91%）；落字延迟 700ms → **150ms**；6 包 1900 词条 + 算法 A/B/C/D + L4 升级 + 学习模式 + 分块流式 + 卸载干净
